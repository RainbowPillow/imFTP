# Deep Imbalance Learning via Fuzzy Set Theory and Prototypical Learning (imFTP, IEEE Transactions on Neural Networks and Learning Systems 2023)

This repository contains the Pytorch implementations of the following IEEE Transactions on Neural Networks and Learning Systems 2023 paper:

Yaxin Hou, Weiping Ding, Chongsheng Zhang. Deep Imbalance Learning via Fuzzy Set Theory and Prototypical Learning. IEEE Transactions on Neural Networks and Learning Systems 2023. &nbsp; &nbsp;[Paper]()
